  ...
  return (
    <div className="space-y-6 animate-fade-in dashboard-module">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
        ...
        <StatCard to={canManageDivisions ? '/admin/divisions' : undefined} icon={Building2} label="Divisions" value={loading ? '—' : (stats.total_divisions ?? 0)} gradient="stat-gradient-purple" />
