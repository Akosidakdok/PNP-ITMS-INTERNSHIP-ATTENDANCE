  ...
  return (
    <header className="navbar">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* User avatar */}
        <Link to={`/${(user?.role === 'admin' || user?.role === 'supervisor' || user?.role === 'superadmin') ? 'admin' : user?.role}/profile`} className="flex items-center gap-2 ml-1 pl-3 border-l border-gray-200 hover:opacity-85 transition-opacity cursor-pointer no-underline text-inherit">
